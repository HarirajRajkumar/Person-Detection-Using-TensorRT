...
class BBoxVisualization():
    ...
    def draw_bboxes(self, img, boxes, confs, clss):
        ...
        print("Number of Persons : " + str(NoPersons))
        if PREV_PERSON_COUNT != NoPersons :        
          print ("Change in Number : from" + str(PREV_PERSON_COUNT) + "to" + str(NoPersons))
          PREV_PERSON_COUNT = NoPersons
